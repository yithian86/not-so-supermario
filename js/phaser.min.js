...
(function () {
  ...
  b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v1.5.0", b.blendModes = {
    ...
    if (this.visible !== !1 && 0 !== this.alpha) {
      var c = this.texture.frame, d = a.context, e = this.texture;
    ...
    for (var d = this.worldTransform, e = !0, f = 0; f < this.children.length; f++) {
      ...
      if (g.visible) {
        ...
        if (c.globalAlpha = this.worldAlpha * g.alpha, g.rotation % (2 * Math.PI) === 0)e && (c.setTransform(d.a, d.c, d.b, d.d, d.tx, d.ty), e = !1), c.drawImage(h.baseTexture.source, i.x, i.y, i.width, i.height, g.anchor.x * -i.width * g.scale.x + g.position.x + .5 | 0, g.anchor.y * -i.height * g.scale.y + g.position.y + .5 | 0, i.width * g.scale.x, i.height * g.scale.y); else {
  ...
  window.requestAnimationFrame || (window.requestAnimationFrame = function (a) {
    ...
    var a = b.gl, c = b.compileProgram(a, this.vertexSrc, this.fragmentSrc);
    ...
    var d = c.gl, e = c.projection, f = c.offset, g = c.shaderManager.primitiveShader;
    ...
    var c = this.gl, d = this.maskStack.pop();
    ...
    if (0 !== this.currentBatchSize) {
      var a = this.gl;
      if (a.bindTexture(a.TEXTURE_2D, this.currentBaseTexture._glTextures[a.id] || b.createWebGLTexture(this.currentBaseTexture, a)), this.currentBatchSize > .5 * this.size)a.bufferSubData(a.ARRAY_BUFFER, 0, this.vertices); else {
    ...
    if (0 !== this.currentBatchSize) {
      var a = this.gl;
      if (this.currentBaseTexture._glTextures[a.id] || b.createWebGLTexture(this.currentBaseTexture, a), a.bindTexture(a.TEXTURE_2D, this.currentBaseTexture._glTextures[a.id]), this.currentBatchSize > .5 * this.size)a.bufferSubData(a.ARRAY_BUFFER, 0, this.vertices); else {
        var c = this.vertices.subarray(0, 4 * this.currentBatchSize * this.vertSize);
        a.bufferSubData(a.ARRAY_BUFFER, 0, c)
      }
      a.drawElements(a.TRIANGLES, 6 * this.currentBatchSize, a.UNSIGNED_SHORT, 0), this.currentBatchSize = 0, this.renderSession.drawCount++
    ...
    var a = this.gl, c = this.filterStack.pop(), d = c.target.filterArea, e = c._glFilterTexture, f = this.renderSession.projection, g = this.renderSession.offset;
    ...
    b.DisplayObjectContainer.call(this), this.renderable = !0, this.fillAlpha = 1, this.lineWidth = 0, this.lineColor = "black", this.graphicsData = [], this.tint = 16777215, this.blendMode = b.blendModes.NORMAL, this.currentPath = {points: []}, this._webGL = [], this.isMask = !1, this.bounds = null, this.boundsPadding = 10
    ...
    var b = this.bounds.x, c = this.bounds.width + this.bounds.x, d = this.bounds.y, e = this.bounds.height + this.bounds.y, f = a || this.worldTransform, g = f.a, h = f.c, i = f.b, j = f.d, k = f.tx, l = f.ty, m = g * c + i * e + k, n = j * e + h * c + l, o = g * b + i * e + k, p = j * e + h * b + l, q = g * b + i * d + k, r = j * d + h * b + l, s = g * c + i * d + k, t = j * d + h * c + l, u = -1 / 0, v = -1 / 0, w = 1 / 0, x = 1 / 0;
    ...
    for (var a, c, d, e, f, g = 1 / 0, h = -1 / 0, i = 1 / 0, j = -1 / 0, k = 0; k < this.graphicsData.length; k++) {
      ...
      if (a = l.points, m === b.Graphics.RECT)c = a[0] - n / 2, d = a[1] - n / 2, e = a[2] + n, f = a[3] + n, g = g > c ? c : g, h = c + e > h ? c + e : h, i = i > d ? c : i, j = d + f > j ? d + f : j; else if (m === b.Graphics.CIRC || m === b.Graphics.ELIP)c = a[0], d = a[1], e = a[2] + n / 2, f = a[3] + n / 2, g = g > c - e ? c - e : g, h = c + e > h ? c + e : h, i = i > d - f ? d - f : i, j = d + f > j ? d + f : j; else for (var o = 0; o < a.length; o += 2)c = a[o], d = a[o + 1], g = g > c - n ? c - n : g, h = c + n > h ? c + n : h, i = i > d - n ? d - n : i, j = d + n > j ? d + n : j
    }
    ...
    if (this.visible !== !1 && 0 !== this.alpha) {
      ...
      var e = this.tilePosition, f = this.tileScale;
    ...
    if (c.baseTexture.hasLoaded) {
      var d, e, f = c.baseTexture, g = c.frame, h = g.width !== f.width || g.height !== f.height, i = !1;
    ...
    if (b.EventTarget.call(this), this.width = 100, this.height = 100, this.scaleMode = c || b.scaleModes.DEFAULT, this.hasLoaded = !1, this.source = a, this.id = b.BaseTextureCacheIdGenerator++, this._glTextures = [], a) {
      if (this.source.complete || this.source.getContext)this.hasLoaded = !0, this.width = this.source.width, this.height = this.source.height, b.texturesToUpdate.push(this); else {
        var d = this;
    ...
    if (b.EventTarget.call(this), c || (this.noFrame = !0, c = new b.Rectangle(0, 0, 1, 1)), a instanceof b.Texture && (a = a.baseTexture), this.baseTexture = a, this.frame = c, this.trim = null, this.scope = this, this._uvs = null, a.hasLoaded)this.noFrame && (c = new b.Rectangle(0, 0, a.width, a.height)), this.setFrame(c); else {
      var d = this;
    ...
    var a = this.frame, c = this.baseTexture.width, d = this.baseTexture.height;
  ...
  PIXI.InteractionManager = function () {
    ...
    var h = c.y - a.y, i = e.y - d.y, j = a.x - c.x, k = d.x - e.x, l = c.x * a.y - a.x * c.y, m = e.x * d.y - d.x * e.y, n = h * k - i * j;
    if (0 === n)return null;
    ...
    memorize: !1, _shouldPropagate: !0, active: !0, validateListener: function (a, b) {
    ...
    this.game = a, this.type = b.WEBGL_FILTER, this.passes = [this], this.shaders = [], this.dirty = !0, this.padding = 0, this.uniforms = {
      time: {
        type: "1f",
        value: 0
      }, resolution: {type: "2f", value: {x: 256, y: 256}}, mouse: {type: "2f", value: {x: 0, y: 0}}
    }, this.fragmentSrc = d || []
  },b.Filter.prototype = {
    init: function () {
    ...
    add: function (a) {
      ...
      if (0 !== this._pluginsLength)for (this._p = 0; this._p < this._pluginsLength; this._p++)if (this.plugins[this._p] === a)return a.destroy(), this.plugins.splice(this._p, 1), void this._pluginsLength--
    }, removeAll: function () {
    ...
    for (var h = 0, i = 0, j = this.children.length; j > i; i++)if (this.children[i][a] === c && (h++, e && (g[0] = this.children[i], e.apply(f, g)), d === b.Group.RETURN_CHILD))return this.children[i];
    ...
    if (null !== this.game) {
      if ("undefined" == typeof a && (a = !0), "undefined" == typeof b && (b = !1), a) {
        if (this.children.length > 0)do this.children[0].parent && this.children[0].destroy(a); while (this.children.length > 0)
      } else this.removeAll();
    ...
    parseConfig: function (a) {
      ...
      var a = b.DEV_VERSION, c = "Canvas", d = "HTML Audio", e = 1;
    ...
    boot: function () {
      ...
      var e = a.worldTransform, f = 1 / (e.a * e.d + e.b * -e.c);
      ...
      for (var i = 0, j = a.children.length; j > i; i++)if (this.hitTest(a.children[i], c, d))return !0;
      return !1
    }
    ...
    start: function (a, c) {
      ...
      if (this.isDragged = !0, this._draggedPointerID = a.id, this._pointerData[a.id].isDragged = !0, this.sprite.fixedToCamera)this.dragFromCenter ? (this.sprite.centerOn(a.x, a.y), this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y)) : this._dragPoint.setTo(this.sprite.cameraOffset.x - a.x, this.sprite.cameraOffset.y - a.y); else if (this.dragFromCenter) {
    ...
    existing: function (a) {
      ...
      var c = Array.prototype.splice.call(arguments, 1), a = new b.Filter[a](this.game);
    ...
    if ("undefined" == typeof a || null === a)this.texture.hasOwnProperty("sourceWidth") && this.texture.setFrame(new b.Rectangle(0, 0, this.texture.sourceWidth, this.texture.sourceHeight)); else if (this.texture instanceof PIXI.Texture) {
      var c = {};
    ...
    if (null !== this.game) {
      ...
      if (a)for (; c--;)this.children[c].destroy(a); else for (; c--;)this.removeChild(this.children[c]);
    ...
    if (null !== this.game) {
      ...
      var c = this.children.length;
      if (a)for (; c--;)this.children[c].destroy ? this.children[c].destroy(a) : this.removeChild(this.children[c]); else for (; c--;)this.removeChild(this.children[c]);
      this.exists = !1, this.visible = !1, this.filters = null, this.mask = null, this.game = null
    }
    ...
    for (var l = this.offsetX, m = this.offsetY, n = 0, o = new b.FrameData, p = 0; p < f.length; p++) {
      var q = a.rnd.uuid(), r = o.addFrame(new b.Frame(p, l, m, this.characterWidth, this.characterHeight, "", q));
    ...
    for (var f = new b.Point, g = 0; g < a.length; g++)if (" " == a.charAt(g))c += this.characterWidth + e; else if (this.grabData[a.charCodeAt(g)] >= 0 && (this.stamp.frame = this.grabData[a.charCodeAt(g)], f.set(c, d), this.render(this.stamp, f, !1), c += this.characterWidth + e, c > this.width))break
    ...
    create: function (a, b, c, d) {
      if ("undefined" == typeof d && (d = !1), a = a || 256, b = b || 256, d)var e = document.createElement("canvas"); else var e = document.createElement(navigator.isCocoonJS ? "screencanvas" : "canvas");
    ...
    _checkOS: function () {
      ...
      if (this.fullscreen)for (var b = 0; b < c.length; b++)this.game.canvas[c[b]] && (this.cancelFullscreen = c[b]);
    ...
    removeRandom: function (a, b, c) {
      if ("undefined" == typeof b && (b = 0), "undefined" == typeof c && (c = 0), null != a) {
        ...
        if ((0 === d || d > a.length - b) && (d = a.length - b), d > 0) {
          var e = b + Math.floor(Math.random() * d), f = a.splice(e, 1);
          return f[0]
        }
      }
      return null
    ...
    reset: function (a, b, c, d, e, f, g) {
      ...
      var b = this.objects, c = this.getIndex(a.body);
    ...
    to: function (a, b, c, d, e, f, g) {
      ...
      for (var d = 0, e = a * (this._duration / 1e3), f = this._duration / e, g = []; e--;) {
        ...
        h = h > 1 ? 1 : h;
        var i = this._easingFunction(h), j = {};
        for (c in this._valuesEnd) {
          var k = this._valuesStart[c] || 0, l = this._valuesEnd[c];
    ...
    create: function (a, c, d, e, f, g) {
      ...
      if (this._len = this.events.length, this.running && this._now >= this.nextTick && this._len > 0) {
        for (this._i = 0; this._i < this._len && this.running && this._now >= this.events[this._i].tick;) {
          var b = this._now - this.events[this._i].tick, c = this._now + this.events[this._i].delay - b;
    ...
    var g = [], h = "";
    if (d > c)for (var i = c; d >= i; i++)h = "number" == typeof f ? b.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h); else for (var i = c; i >= d; i--)h = "number" == typeof f ? b.Utils.pad(i.toString(), f, "0", 1) : i.toString(), h = a + h + e, g.push(h);
    return g
    ...
    spriteSheet: function (a, c, d, e, f, g, h) {
      ...
      var e, f = new b.FrameData, g = c.frames, h = 0;
      for (var i in g) {
        var j = a.rnd.uuid();
    ...
    addCanvas: function (a, b, c) {
      ...
      this._textures[a] = {texture: c, frame: d}
      ...
      this._physics[a] = {url: b, data: c, format: d}
    ...
    setPreloadSprite: function (a, c) {
      ...
      } else this.addToFileList("tilemap", a, c, {format: e});
      return this
      ...
      if ("undefined" == typeof d && (d = null), "undefined" == typeof e && (e = null), "undefined" == typeof f && (f = b.Loader.TEXTURE_ATLAS_JSON_ARRAY), d)this.addToFileList("textureatlas", a, c, {
        ...
        this.addToFileList("textureatlas", a, c, {atlasURL: null, atlasData: e, format: f})
      }
      return this
      ...
      var a = this._fileList[this._fileIndex], c = this;
      switch (a.type) {
        case"image":
        case"spritesheet":
        case"textureatlas":
      ...
      switch (c.type) {
        ...
        case"spritesheet":
          ...
          break;
        case"textureatlas":
          if (null == c.atlasURL)this.game.cache.addTextureAtlas(c.key, c.url, c.data, c.atlasData, c.format); else {
    ...
    bitmapFont: function (a, b, c, d, e) {
      if (!b || /MSIE 9/i.test(navigator.userAgent))if ("function" == typeof window.DOMParser) {
        var f = new DOMParser;
      ...
      var h = {}, i = b.getElementsByTagName("info")[0], j = b.getElementsByTagName("common")[0];
      ...
      for (var k = b.getElementsByTagName("char"), l = PIXI.TextureCache[c], m = 0; m < k.length; m++) {
        var n = parseInt(k[m].getAttribute("id"), 10), o = new PIXI.Rectangle(parseInt(k[m].getAttribute("x"), 10), parseInt(k[m].getAttribute("y"), 10), parseInt(k[m].getAttribute("width"), 10), parseInt(k[m].getAttribute("height"), 10));
        h.chars[n] = {
      ...
      for (m = 0; m < p.length; m++) {
        var q = parseInt(p[m].getAttribute("first"), 10), r = parseInt(p[m].getAttribute("second"), 10), s = parseInt(p[m].getAttribute("amount"), 10);
    ...
    getColor32: function (a, b, c, d) {
      ...
      var c = b.Color.getRGB(a), d = b.Color.RGBtoHSV(a), e = b.Color.RGBtoHexstring(a) + "\n";
      ...
      var g = b.Color.getRGB(a), h = b.Color.getRGB(c), i = (h.red - g.red) * e / d + g.red, j = (h.green - g.green) * e / d + g.green, k = (h.blue - g.blue) * e / d + g.blue;
      return b.Color.getColor32(f, i, j, k)
    }, interpolateColorWithRGB: function (a, c, d, e, f, g) {
      var h = b.Color.getRGB(a), i = (c - h.red) * g / f + h.red, j = (d - h.green) * g / f + h.green, k = (e - h.blue) * g / f + h.blue;
      return b.Color.getColor(i, j, k)
    }, interpolateRGB: function (a, c, d, e, f, g, h, i) {
      var j = (e - a) * i / h + a, k = (f - c) * i / h + c, l = (g - d) * i / h + d;
      ...
      var e = a + Math.round(Math.random() * (c - a)), f = a + Math.round(Math.random() * (c - a)), g = a + Math.round(Math.random() * (c - a));
      return b.Color.getColor32(d, e, f, g)
    }, getRGB: function (a) {
      return {alpha: a >>> 24, red: a >> 16 & 255, green: a >> 8 & 255, blue: 255 & a}
    }, getWebRGB: function (a) {
      var b = (a >>> 24) / 255, c = a >> 16 & 255, d = a >> 8 & 255, e = 255 & a;
    ...
    setBounds: function (a, b, c, d) {
      ...
      "undefined" == typeof c && (c = !0);
      var d = 1;
      if (Array.isArray(a))for (d = a.length; d--;)a[d] instanceof b.Group ? this.enable(a[d].children, c) : (this.enableBody(a[d]), c && a[d].hasOwnProperty("children") && a[d].children.length > 0 && this.enable(a[d], !0)); else a instanceof b.Group ? this.enable(a.children, c) : (this.enableBody(a), c && a.hasOwnProperty("children") && a.children.length > 0 && this.enable(a.children, !0))
      ...
      if (0 !== a.length)for (var f = a.children.length, g = 0; f > g; g++)for (var h = g + 1; f >= h; h++)a.children[g] && a.children[h] && a.children[g].exists && a.children[h].exists && this.collideSpriteVsSprite(a.children[g], a.children[h], b, c, d, e)
      ...
      if (this._mapData = b.getTiles(a.body.position.x - a.body.tilePadding.x, a.body.position.y - a.body.tilePadding.y, a.body.width + a.body.tilePadding.x, a.body.height + a.body.tilePadding.y, !1, !1), 0 !== this._mapData.length)for (var f = 0; f < this._mapData.length; f++)this.separateTile(f, a.body, this._mapData[f]) && (d ? d.call(e, a, this._mapData[f]) && (this._total++, c && c.call(e, a, this._mapData[f])) : (this._total++, c && c.call(e, a, this._mapData[f])))
    ...
    create: function (a, b, c, d, e) {
      ...
      for (var k, l = 0, m = this.objects[a].length; m > l; l++)if (this.objects[a][l].gid === c) {
      ...
      var m = l.widthInPixels, n = l.heightInPixels;
    ...
    for (var f = a.coordinatesOnLine(b), g = f.length, h = [], i = 0; i < e.length; i++)for (var j = 0; g > j; j++)if (e[i].containsPoint(f[j][0], f[j][1])) {
      h.push(e[i]);
      break
    }
    return h
    ...
    for (var g = this._mc.ty; g < this._mc.ty + this._mc.th; g++)for (var h = this._mc.tx; h < this._mc.tx + this._mc.tw; h++)this.layer.data[g] && this.layer.data[g][h] && (!e && !f || this.layer.data[g][h].isInteresting(e, f)) && this._results.push(this.layer.data[g][h]);
    return this._results
    ...
    parse: function (a, c, d, e, f, g) {
      ...
      for (var n = [], e = 0; e < a.tilesets.length; e++) {
        var o = a.tilesets[e], p = new b.Tileset(o.name, o.firstgid, o.tilewidth, o.tileheight, o.margin, o.spacing, o.properties);
      ...
      c.tilesets = n;
      for (var q = {}, r = {}, e = 0; e < a.layers.length; e++)if ("objectgroup" === a.layers[e].type) {
        q[a.layers[e].name] = [], r[a.layers[e].name] = [];
        for (var s = 0, k = a.layers[e].objects.length; k > s; s++)if (a.layers[e].objects[s].gid) {
          var t = {
      ...
      for (var e = 0; e < c.tilesets.length; e++)for (var o = c.tilesets[e], g = o.tileMargin, v = o.tileMargin, w = 0, x = 0, y = 0, j = o.firstgid; j < o.firstgid + o.total && (c.tiles[j] = [g, v, e], g += o.tileWidth + o.tileSpacing, w++, w !== o.total) && (x++, x !== o.columns || (g = o.tileMargin, v += o.tileHeight + o.tileSpacing, x = 0, y++, y !== o.rows)); j++);
      return c
    }
  ...
  enableAABB: function (a, b) {
    ...
    for (var d = 0, e = a.layers[b].height; e > d; d++)for (var f = 0, g = a.layers[b].width; g > f; f++) {
    ...
    if (0 !== b.length)for (var g = 0, h = b.children.length; h > g; g++)b.children[g].exists && b.children[g].body && this.separate(a.body, b.children[g].body, d, e, f) && (c && c.call(e, a, b.children[g]), this._total++)
  }, collideGroupVsSelf: function (a, b, c, d, e) {
    if (0 !== a.length)for (var f = a.children.length, g = 0; f > g; g++)for (var h = g + 1; f >= h; h++)a.children[g] && a.children[h] && a.children[g].exists && a.children[h].exists && this.collideSpriteVsSprite(a.children[g], a.children[h], b, c, d, e)
  }, collideGroupVsGroup: function (a, b, c, d, e, f) {
    if (0 !== a.length && 0 !== b.length)for (var g = 0, h = a.children.length; h > g; g++)a.children[g].exists && this.collideSpriteVsGroup(a.children[g], b, c, d, e, f)
  ...
  preUpdate: function () {
    ...
    var c = a * this.game.time.physicsElapsed, b = this.game.math.degToRad(b);
  ...
  integrate: function () {
    ...
    var e, f, g, h, i, j = this.pos, k = this.oldpos, l = j.x - k.x, m = j.y - k.y, n = l * c + m * d, o = n * c, p = n * d, q = l - o, r = m - p;
    ...
    var a = this.pos.x - this.oldpos.x, b = this.pos.y - this.oldpos.y;
    ...
    {
      var f = this.pos.x - this.oldpos.x, g = this.pos.y - this.oldpos.y, h = f * c + g * d;
    ...
    var b = this.pos, c = a, d = c.pos.x, e = c.pos.y, f = c.xw, g = c.yw, h = b.x - d, i = f + this.xw - Math.abs(h);
    if (i > 0) {
      var j = b.y - e, k = g + this.yw - Math.abs(j);
      if (k > 0) {
    ...
    var b = this.pos.x - a.pos.x, c = a.xw + this.xw - Math.abs(b);
    if (c > 0) {
      var d = this.pos.y - a.pos.y, e = a.yw + this.yw - Math.abs(d);
    ...
    var e = d.signx, f = d.signy, g = c.pos.x - e * c.xw - d.pos.x, h = c.pos.y - f * c.yw - d.pos.y, i = g * e + h * f;
    if (0 > i) {
      e *= -i, f *= -i;
      var j = Math.sqrt(e * e + f * f), k = Math.sqrt(a * a + b * b);
    ...
    var e = d.signx, f = d.signy, g = c.pos.x - e * c.xw - d.pos.x, h = c.pos.y - f * c.yw - d.pos.y, i = d.sx, j = d.sy, k = g * i + h * j;
    if (0 > k) {
      i *= -k, j *= -k;
      var l = Math.sqrt(i * i + j * j), m = Math.sqrt(a * a + b * b);
    ...
    var e = d.signx, f = d.signy, g = c.pos.y - f * c.yw, h = d.pos.y - g;
    if (h * f > 0) {
      var i = c.pos.x - e * c.xw - (d.pos.x + e * d.xw), j = c.pos.y - f * c.yw - (d.pos.y - f * d.yw), k = d.sx, l = d.sy, m = i * k + j * l;
      if (0 > m) {
        k *= -m, l *= -m;
        var n = Math.sqrt(k * k + l * l), o = Math.sqrt(a * a + b * b), p = Math.abs(h);
    ...
    var e = d.signx, f = d.signy, g = c.pos.x - e * c.xw - (d.pos.x - e * d.xw), h = c.pos.y - f * c.yw - (d.pos.y + f * d.yw), i = d.sx, j = d.sy, k = g * i + h * j;
    if (0 > k) {
      i *= -k, j *= -k;
      var l = Math.sqrt(i * i + j * j), m = Math.sqrt(a * a + b * b);
    ...
    var e = d.signx, f = d.signy, g = c.pos.x - e * c.xw, h = d.pos.x - g;
    if (h * e > 0) {
      var i = c.pos.x - e * c.xw - (d.pos.x - e * d.xw), j = c.pos.y - f * c.yw - (d.pos.y + f * d.yw), k = d.sx, l = d.sy, m = i * k + j * l;
      if (0 > m) {
        k *= -m, l *= -m;
    ...
    var e = d.signx, f = d.signy, g = c.pos.x - e * c.xw - (d.pos.x - e * d.xw), h = c.pos.y - f * c.yw - (d.pos.y - f * d.yw), i = Math.sqrt(g * g + h * h), j = 2 * d.xw, k = Math.sqrt(j * j + 0), l = k - i;
    if (0 > e * g || 0 > f * h) {
    ...
    var e = d.signx, f = d.signy, g = d.pos.x + e * d.xw - (c.pos.x - e * c.xw), h = d.pos.y + f * d.yw - (c.pos.y - f * c.yw), i = 2 * d.xw, j = Math.sqrt(i * i + 0), k = Math.sqrt(g * g + h * h), l = k - j;
    if (l > 0) {
      var m = Math.sqrt(a * a + b * b);
  ...
  integrate: function () {
    ...
    if (this.id < Phaser.Physics.Ninja.Tile.TYPE_45DEG)this.type = Phaser.Physics.Ninja.Tile.TYPE_FULL, this.signx = 0, this.signy = 0, this.sx = 0, this.sy = 0; else if (this.id < Phaser.Physics.Ninja.Tile.TYPE_CONCAVE)if (this.type = Phaser.Physics.Ninja.Tile.TYPE_45DEG, this.id == Phaser.Physics.Ninja.Tile.SLOPE_45DEGpn)this.signx = 1, this.signy = -1, this.sx = this.signx / Math.SQRT2, this.sy = this.signy / Math.SQRT2; else if (this.id == Phaser.Physics.Ninja.Tile.SLOPE_45DEGnn)this.signx = -1, this.signy = -1, this.sx = this.signx / Math.SQRT2, this.sy = this.signy / Math.SQRT2; else if (this.id == Phaser.Physics.Ninja.Tile.SLOPE_45DEGnp)this.signx = -1, this.signy = 1, this.sx = this.signx / Math.SQRT2, this.sy = this.signy / Math.SQRT2; else {
      ...
      var a = Math.sqrt(5);
      this.sx = 1 * this.signx / a, this.sy = 2 * this.signy / a
    } else if (this.id < Phaser.Physics.Ninja.Tile.TYPE_67DEGs)if (this.type = Phaser.Physics.Ninja.Tile.TYPE_22DEGb, this.id == Phaser.Physics.Ninja.Tile.SLOPE_22DEGpnB) {
      this.signx = 1, this.signy = -1;
      var a = Math.sqrt(5);
      this.sx = 1 * this.signx / a, this.sy = 2 * this.signy / a
      ...
      var a = Math.sqrt(5);
      this.sx = 1 * this.signx / a, this.sy = 2 * this.signy / a
    } else if (this.id < Phaser.Physics.Ninja.Tile.TYPE_67DEGb)if (this.type = Phaser.Physics.Ninja.Tile.TYPE_67DEGs, this.id == Phaser.Physics.Ninja.Tile.SLOPE_67DEGpnS) {
      this.signx = 1, this.signy = -1;
      var a = Math.sqrt(5);
      ...
      var a = Math.sqrt(5);
      this.sx = 2 * this.signx / a, this.sy = 1 * this.signy / a
    } else if (this.id < Phaser.Physics.Ninja.Tile.TYPE_HALF)if (this.type = Phaser.Physics.Ninja.Tile.TYPE_67DEGb, this.id == Phaser.Physics.Ninja.Tile.SLOPE_67DEGpnB) {
      this.signx = 1, this.signy = -1;
      var a = Math.sqrt(5);
      this.sx = 2 * this.signx / a, this.sy = 1 * this.signy / a
  ...
  integrate: function () {
    ...
    var b = this.pos, c = this.radius, d = a, e = d.pos.x, f = d.pos.y, g = d.xw, h = d.yw, i = b.x - e, j = g + c - Math.abs(i);
    if (j > 0) {
      var k = b.y - f, l = h + c - Math.abs(k);
    ...
    var i = f.pos.x + c * f.xw, j = f.pos.y + d * f.yw, g = e.pos.x - i, h = e.pos.y - j, k = Math.sqrt(g * g + h * h), l = e.radius - k;
    ...
    var g, h = f.signx, i = f.signy;
    if (0 == c)if (0 == d) {
      var j = f.sx, k = f.sy, l = e.pos.x - j * e.radius - f.pos.x, m = e.pos.y - k * e.radius - f.pos.y, n = l * j + m * k;
      if (0 > n) {
      ...
      var j = f.sx, k = f.sy, l = e.pos.x - (f.pos.x - h * f.xw), m = e.pos.y - (f.pos.y + d * f.yw), p = l * -k + m * j;
      if (p * h * i > 0) {
        var q = Math.sqrt(l * l + m * m), r = e.radius - q;
        if (r > 0)return l /= q, m /= q, e.reportCollisionVsWorld(l * r, m * r, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
        var n = l * j + m * k, r = e.radius - Math.abs(n);
      ...
      var j = f.sx, k = f.sy, l = e.pos.x - (f.pos.x + c * f.xw), m = e.pos.y - (f.pos.y - i * f.yw), p = l * -k + m * j;
      if (0 > p * h * i) {
        var q = Math.sqrt(l * l + m * m), r = e.radius - q;
        if (r > 0)return l /= q, m /= q, e.reportCollisionVsWorld(l * r, m * r, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
      ...
      var s = f.pos.x + c * f.xw, t = f.pos.y + d * f.yw, u = e.pos.x - s, v = e.pos.y - t, q = Math.sqrt(u * u + v * v), r = e.radius - q;
    ...
    if (0 == c) {
      if (0 == d) {
        var j = f.pos.x + h * f.xw - e.pos.x, k = f.pos.y + i * f.yw - e.pos.y, l = 2 * f.xw, m = Math.sqrt(l * l + 0), n = Math.sqrt(j * j + k * k), o = n + e.radius - m;
      ...
      if (0 > i * d)return e.reportCollisionVsWorld(0, b * d, 0, d, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var p = f.pos.x - h * f.xw, q = f.pos.y + d * f.yw, r = e.pos.x - p, s = e.pos.y - q, n = Math.sqrt(r * r + s * s), o = e.radius - n;
      if (o > 0)return 0 == n ? (r = 0, s = d) : (r /= n, s /= n), e.reportCollisionVsWorld(r * o, s * o, r, s, f), Phaser.Physics.Ninja.Circle.COL_OTHER
    } else if (0 == d) {
      if (0 > h * c)return e.reportCollisionVsWorld(a * c, 0, c, 0, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var p = f.pos.x + c * f.xw, q = f.pos.y - i * f.yw, r = e.pos.x - p, s = e.pos.y - q, n = Math.sqrt(r * r + s * s), o = e.radius - n;
      if (o > 0)return 0 == n ? (r = c, s = 0) : (r /= n, s /= n), e.reportCollisionVsWorld(r * o, s * o, r, s, f), Phaser.Physics.Ninja.Circle.COL_OTHER
    } else {
      if (h * c + i * d > 0)return Phaser.Physics.Ninja.Circle.COL_NONE;
      var p = f.pos.x + c * f.xw, q = f.pos.y + d * f.yw, r = e.pos.x - p, s = e.pos.y - q, n = Math.sqrt(r * r + s * s), o = e.radius - n;
    ...
    var g, h = f.signx, i = f.signy;
    if (0 == c)if (0 == d) {
      var j = e.pos.x - (f.pos.x - h * f.xw), k = e.pos.y - (f.pos.y - i * f.yw), l = 2 * f.xw, m = Math.sqrt(l * l + 0), n = Math.sqrt(j * j + k * k), o = m + e.radius - n;
    ...
    var g = f.signx, h = f.signy, i = c * g + d * h;
    if (i > 0)return Phaser.Physics.Ninja.Circle.COL_NONE;
    if (0 == c)if (0 == d) {
      var j = e.radius, k = e.pos.x - g * j - f.pos.x, l = e.pos.y - h * j - f.pos.y, m = g, n = h, o = k * m + l * n;
      if (0 > o) {
        m *= -o, n *= -o;
        var p = Math.sqrt(m * m + n * n), q = Math.sqrt(a * a + b * b);
      ...
      var j = e.radius, r = e.pos.x - f.pos.x;
      if (0 > r * g)return e.reportCollisionVsWorld(0, b * d, 0, d, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var s = e.pos.y - (f.pos.y + d * f.yw), t = Math.sqrt(r * r + s * s), u = e.radius - t;
      ...
      var j = e.radius, s = e.pos.y - f.pos.y;
      if (0 > s * h)return e.reportCollisionVsWorld(a * c, 0, c, 0, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var r = e.pos.x - (f.pos.x + c * f.xw), t = Math.sqrt(r * r + s * s), u = e.radius - t;
      if (u > 0)return 0 == t ? (r = g / Math.SQRT2, s = d / Math.SQRT2) : (r /= t, s /= t), e.reportCollisionVsWorld(r * u, s * u, r, s, f), Phaser.Physics.Ninja.Circle.COL_OTHER
    } else {
      var v = f.pos.x + c * f.xw, w = f.pos.y + d * f.yw, r = e.pos.x - v, s = e.pos.y - w, t = Math.sqrt(r * r + s * s), u = e.radius - t;
    ...
    if (0 == c) {
      ...
      var i = f.sx, j = f.sy, k = e.radius, l = e.pos.x - (f.pos.x - g * f.xw), m = e.pos.y - f.pos.y, n = l * -j + m * i;
      if (n * g * h > 0) {
        var o = Math.sqrt(l * l + m * m), p = k - o;
    ...
    } else if (0 == d)if (0 > g * c) {
      var s = f.pos.x - g * f.xw, t = f.pos.y, u = e.pos.x - s, v = e.pos.y - t;
      if (0 > v * h)return e.reportCollisionVsWorld(a * c, 0, c, 0, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var o = Math.sqrt(u * u + v * v), p = e.radius - o;
      ...
      var i = f.sx, j = f.sy, l = e.pos.x - (f.pos.x + c * f.xw), m = e.pos.y - (f.pos.y - h * f.yw), n = l * -j + m * i;
      if (0 > n * g * h) {
        var o = Math.sqrt(l * l + m * m), p = e.radius - o;
        if (p > 0)return l /= o, m /= o, e.reportCollisionVsWorld(l * p, m * p, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
        var q = l * i + m * j, p = e.radius - Math.abs(q);
        if (p > 0)return e.reportCollisionVsWorld(i * p, j * p, i, j, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      }
    } else {
      var s = f.pos.x + c * f.xw, t = f.pos.y + d * f.yw, u = e.pos.x - s, v = e.pos.y - t, o = Math.sqrt(u * u + v * v), p = e.radius - o;
      if (p > 0)return 0 == o ? (u = c / Math.SQRT2, v = d / Math.SQRT2) : (u /= o, v /= o), e.reportCollisionVsWorld(u * p, v * p, u, v, f), Phaser.Physics.Ninja.Circle.COL_OTHER
    }
    return Phaser.Physics.Ninja.Circle.COL_NONE
    ...
    var g = f.signx, h = f.signy;
    if (0 == c)if (0 == d) {
      var i = f.sx, j = f.sy, k = e.radius, l = e.pos.x - i * k - (f.pos.x - g * f.xw), m = e.pos.y - j * k - (f.pos.y + h * f.yw), n = l * i + m * j;
      if (0 > n) {
        i *= -n, j *= -n;
      ...
      var i = f.sx, j = f.sy, l = e.pos.x - (f.pos.x - g * f.xw), m = e.pos.y - (f.pos.y + h * f.yw), p = l * -j + m * i;
      if (p * g * h > 0) {
        var q = Math.sqrt(l * l + m * m), r = e.radius - q;
        if (r > 0)return l /= q, m /= q, e.reportCollisionVsWorld(l * r, m * r, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
        var n = l * i + m * j, r = e.radius - Math.abs(n);
      ...
      if (g * c + h * d > 0) {
        var s = Math.sqrt(5), i = 1 * g / s, j = 2 * h / s, k = e.radius, l = e.pos.x - i * k - (f.pos.x - g * f.xw), m = e.pos.y - j * k - (f.pos.y + h * f.yw), n = l * i + m * j;
      ...
      var t = f.pos.x + c * f.xw, u = f.pos.y + d * f.yw, v = e.pos.x - t, w = e.pos.y - u, q = Math.sqrt(v * v + w * w), r = e.radius - q;
    ...
    if (0 == c)if (0 == d) {
      var i = f.sx, j = f.sy, k = e.radius, l = e.pos.x - f.pos.x, m = e.pos.y - (f.pos.y - h * f.yw), n = l * -j + m * i;
      if (0 > n * g * h) {
        var o = Math.sqrt(l * l + m * m), p = k - o;
        if (p > 0)return l /= o, m /= o, e.reportCollisionVsWorld(l * p, m * p, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
      ...
      var s = f.pos.x, t = f.pos.y - h * f.yw, u = e.pos.x - s, v = e.pos.y - t;
      if (0 > u * g)return e.reportCollisionVsWorld(0, b * d, 0, d, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var o = Math.sqrt(u * u + v * v), p = e.radius - o;
      if (p > 0)return 0 == o ? (u = c / Math.SQRT2, v = d / Math.SQRT2) : (u /= o, v /= o), e.reportCollisionVsWorld(u * p, v * p, u, v, f), Phaser.Physics.Ninja.Circle.COL_OTHER
    } else {
      var i = f.sx, j = f.sy, l = e.pos.x - (f.pos.x - g * f.xw), m = e.pos.y - (f.pos.y + d * f.yw), n = l * -j + m * i;
      if (n * g * h > 0) {
        var o = Math.sqrt(l * l + m * m), p = e.radius - o;
        if (p > 0)return l /= o, m /= o, e.reportCollisionVsWorld(l * p, m * p, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
    ...
    if (0 == c)if (0 == d) {
      ...
      if (0 > h * d)return e.reportCollisionVsWorld(0, b * d, 0, d, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var l = e.pos.x - f.pos.x, m = e.pos.y - (f.pos.y + h * f.yw);
      ...
      if (0 > g * c)return e.reportCollisionVsWorld(a * c, 0, c, 0, f), Phaser.Physics.Ninja.Circle.COL_AXIS;
      var s = Math.sqrt(5), i = 2 * g / s, j = 1 * h / s, l = e.pos.x - (f.pos.x + g * f.xw), m = e.pos.y - (f.pos.y - h * f.yw), p = l * -j + m * i;
      if (0 > p * g * h) {
        var q = Math.sqrt(l * l + m * m), r = e.radius - q;
        if (r > 0)return l /= q, m /= q, e.reportCollisionVsWorld(l * r, m * r, l, m, f), Phaser.Physics.Ninja.Circle.COL_OTHER
      } else {
  ...
  return function a(b, c, d) {
    ...
    1: [function (a, b, c) {
      var d = {}, e = new Float32Array([1, 0, 0, 1]);
      if (!f)var f = 1e-6;
      d.create = function () {
    ...
    9: [function (a, b) {
      ...
      c.prototype.setFromPoints = function (a, b, c) {
        var f = this.lowerBound, g = this.upperBound;
    ...
    11: [function (a, b) {
      ...
      {
        var e = a("../shapes/Circle"), f = a("../shapes/Plane"), g = a("../shapes/Particle"), h = a("../collision/Broadphase");
        a("../math/vec2")
      }
      b.exports = d, d.prototype = new h, d.prototype.getBinIndex = function (a, b) {
        var c = this.nx, d = this.ny, e = this.xmin, f = this.ymin, g = this.xmax, h = this.ymax, i = Math.floor(c * (a - e) / (g - e)), j = Math.floor(d * (b - f) / (h - f));
        return i * d + j
        ...
        for (var o = nx / (xmax - xmin), p = ny / (ymax - ymin), n = 0; n !== i; n++) {
          var q = d[n], r = q.shape;
          if (void 0 !== r)if (r instanceof e)for (var s = q.position[0], t = q.position[1], u = r.radius, v = Math.floor(o * (s - u - xmin)), w = Math.floor(p * (t - u - ymin)), x = Math.floor(o * (s + u - xmin)), y = Math.floor(p * (t + u - ymin)), z = v; x >= z; z++)for (var A = w; y >= A; A++) {
            var B = z, C = A;
            B * (ny - 1) + C >= 0 && m > B * (ny - 1) + C && l[B * (ny - 1) + C].push(q)
          } else {
            if (!(r instanceof f))throw new Error("Shape not supported in GridBroadphase!");
            if (0 == q.angle)for (var t = q.position[1], z = 0; z !== m && t > ymin + k * (z - 1); z++)for (var A = 0; nx > A; A++) {
              var B = A, C = Math.floor(p * (k * z - ymin));
              l[B * (ny - 1) + C].push(q)
            } else if (q.angle == .5 * Math.PI)for (var s = q.position[0], z = 0; z !== m && s > xmin + j * (z - 1); z++)for (var A = 0; ny > A; A++) {
              var C = A, B = Math.floor(o * (j * z - xmin));
              l[B * (ny - 1) + C].push(q)
            } else for (var z = 0; z !== m; z++)l[z].push(q)
          }
        }
        for (var n = 0; n !== m; n++)for (var D = l[n], z = 0, E = D.length; z !== E; z++)for (var q = D[z], r = q.shape, A = 0; A !== z; A++) {
          var F = D[A], G = F.shape;
    ...
    12: [function (a, b) {
      ...
      b.exports = c, c.prototype = new d, c.prototype.getCollisionPairs = function (a) {
        var b, c, e, f, g = a.bodies, h = this.result, i = this.useBoundingBoxes ? d.aabbCheck : d.boundingRadiusCheck;
        for (h.length = 0, b = 0, Ncolliding = g.length; b !== Ncolliding; b++)for (e = g[b], c = 0; b > c; c++)f = g[c], d.canCollide(e, f) && i(e, f) && h.push(e, f);
        return h
      }
    }, {
      "../collision/Broadphase": 10,
    ...
    13: [function (a, b) {
      ...
      var g = a("../math/vec2"), h = g.sub, i = g.add, j = g.dot, k = a("../utils/Utils"), l = a("../equations/ContactEquation"), m = a("../equations/FrictionEquation"), n = a("../shapes/Circle"), o = a("../shapes/Shape"), p = a("../objects/Body"), q = a("../shapes/Rectangle");
      b.exports = c;
      var r = g.fromValues(0, 1), s = g.fromValues(0, 0), t = g.fromValues(0, 0), u = g.fromValues(0, 0), v = g.fromValues(0, 0), w = g.fromValues(0, 0), x = g.fromValues(0, 0), y = g.fromValues(0, 0), z = g.fromValues(0, 0), A = g.fromValues(0, 0), B = g.fromValues(0, 0), C = g.fromValues(0, 0), D = g.fromValues(0, 0), E = g.fromValues(0, 0), F = g.fromValues(0, 0), G = g.fromValues(0, 0), H = g.fromValues(0, 0), I = g.fromValues(0, 0), J = g.fromValues(0, 0), K = [];
      c.prototype.collidedLastStep = function (a, b) {
        ...
        for (var a = 0; a !== this.contactEquations.length; a++) {
          var b = this.contactEquations[a], c = b.bi.id, e = b.bj.id;
          if (c > e) {
            var f = c;
            c = e, e = f
          }
        ...
        if (this.reuseObjects) {
          var h = this.contactEquations, i = this.frictionEquations, j = this.reusableFrictionEquations, l = this.reusableContactEquations;
      ...
      var N = g.create(), O = g.create(), P = new q(1, 1);
      c.prototype[o.CAPSULE | o.CAPSULE] = c.prototype.capsuleCapsule = function (a, b, c, d, f, h, i, j, k) {
        ...
        var n = s, o = t, p = u, q = v, B = w, C = x, D = y, E = z, F = A, G = K;
        ...
        var p = f, q = l, r = e, G = k, H = c, I = a, J = b, n = n || 0, o = "undefined" != typeof o ? o : J.radius, L = s, M = t, N = u, O = v, P = w, Q = x, R = y, S = z, T = A, U = B, V = C, W = D, X = E, Y = F, Z = K;
        ...
        var o = j, p = l, q = e, r = k, x = c, y = a, z = b, n = "number" == typeof n ? n : z.radius, A = s, D = t, I = u, J = v, K = w, L = B, M = C, N = E, O = F, P = G, Q = H, R = !1, S = Number.MAX_VALUE;
        verts = o.vertices;
        for (var T = 0; T !== verts.length + 1; T++) {
          var U = verts[T % verts.length], V = verts[(T + 1) % verts.length];
        ...
        if (n > 0)for (var T = 0; T < verts.length; T++) {
          var Y = verts[T];
      ...
      var Q = g.create(), R = g.create(), S = g.create(), T = g.create();
      c.prototype[o.PARTICLE | o.CONVEX] = c.prototype[o.PARTICLE | o.RECTANGLE] = c.prototype.particleConvex = function (a, b, c, d, e, k, l, m, n) {
        var o = k, p = m, q = e, r = l, z = c, A = a, C = s, D = t, F = u, G = v, H = w, K = x, L = y, M = B, N = E, O = I, P = J, Q = Number.MAX_VALUE, R = !1, S = o.vertices;
        if (!f(z, o, r, p))return 0;
        if (n)return !0;
        for (var T = 0; T !== S.length + 1; T++) {
          var U = S[T % S.length], V = S[(T + 1) % S.length];
        ...
        var o = a, p = b, q = c, r = e, t = f, u = j, v = s, m = m || p.radius, n = n || t.radius;
        h(v, c, j);
        var w = m + n;
        ...
        var n = e, o = k, p = f, q = l, v = a, w = b, x = c, y = d, z = s, A = t, B = u, C = 0;
        g.rotate(A, r, y);
        ...
        var m = a, n = c, o = e, p = i, q = k, u = s, v = t;
      ...
      {
        var U = new n(1), V = g.create(), W = g.create();
        g.create()
      }
      c.prototype[o.PLANE | o.CAPSULE] = c.prototype.planeCapsule = function (a, b, c, d, e, f, h, j, k) {
        ...
        var o = this.circlePlane(e, n, l, 0, a, b, c, d, k), p = this.circlePlane(e, n, m, 0, a, b, c, d, k);
        return k ? o || p : o + p
        ...
        var p = s, q = t, r = u, x = v, B = w, C = y, D = z, E = A, F = 0, o = o || c.convexPrecision, G = c.findSeparatingAxis(b, d, e, k, l, m, p);
        if (!G)return 0;
        h(D, l, d), j(p, D) > 0 && g.scale(p, p, -1);
        var H = c.getClosestEdge(b, e, p, !0), I = c.getClosestEdge(k, m, p);
        if (-1 == H || -1 == I)return 0;
        for (var J = 0; 2 > J; J++) {
          var K = H, L = I, M = b, N = k, O = d, P = l, Q = e, R = m, S = a, T = f;
          if (0 == J) {
            var U;
      ...
      var Y = g.fromValues(0, 0), Z = g.fromValues(0, 0), $ = g.fromValues(0, 0), _ = g.fromValues(0, 0), ab = g.fromValues(0, 0), bb = g.fromValues(0, 0);
      ...
      var cb = g.fromValues(0, 0), db = g.fromValues(0, 0), eb = g.fromValues(0, 0);
      ...
      var fb = g.create(), gb = g.create(), hb = g.create(), ib = g.create(), jb = g.create(), kb = g.create(), lb = g.create();
      c.prototype[o.CIRCLE | o.HEIGHTFIELD] = c.prototype.circleHeightfield = function (a, b, c, d, e, f, j, k, l, m) {
        var n = f.data, m = m || b.radius, o = f.elementWidth, p = gb, q = fb, r = jb, s = lb, t = kb, u = hb, v = ib, w = Math.floor((c[0] - m - j[0]) / o), x = Math.ceil((c[0] + m - j[0]) / o);
        ...
        if (m > 0)for (var A = w; x >= A; A++)if (g.set(u, A * o, n[A]), g.add(u, u, j), g.sub(p, c, u), g.squaredLength(p) < m * m) {
          if (l)return !0;
          var E = this.createContactEquation(e, a, f, b);
    ...
    14: [function (a, b) {
      ...
      var f = a("../shapes/Plane"), g = a("../collision/Broadphase");
      b.exports = {QuadTree: c, Node: d, BoundsNode: e}, c.prototype.insert = function (a) {
        if (a instanceof Array)for (var b = a.length, c = 0; b > c; c++)this.root.insert(a[c]); else this.root.insert(a)
      }, c.prototype.clear = function () {
        this.root.clear()
        ...
        for (var c = 0; c !== a.bodies.length; c++)for (var d = a.bodies[c], e = this.retrieve(d), f = 0, h = e.length; f !== h; f++) {
          var i = e[f];
          if (d !== i) {
        ...
        var b = this.bounds, c = a.position[0] - a.boundingRadius > b.x + b.width / 2 ? !1 : !0, e = a.position[1] - a.boundingRadius > b.y + b.height / 2 ? !1 : !0;
        a instanceof f && (c = e = !1);
        var g = d.TOP_LEFT;
        return c ? e || (g = d.BOTTOM_LEFT) : g = e ? d.TOP_RIGHT : d.BOTTOM_RIGHT, g
      }, d.prototype.subdivide = function () {
        var a = this.depth + 1, b = this.bounds.x, c = this.bounds.y, e = this.bounds.width / 2, f = this.bounds.height / 2, g = b + e, h = c + f;
        this.nodes[d.TOP_LEFT] = new this.classConstructor({
          ...
          width: e,
          height: f
        }, a), this.nodes[d.BOTTOM_RIGHT] = new this.classConstructor({x: g, y: h, width: e, height: f}, a)
        ...
        if (this.nodes.length) {
          var b = this.findIndex(a), c = this.nodes[b];
    ...
    }, {"../collision/Broadphase": 10, "../shapes/Plane": 43}],
    15: [function (a, b) {
      function c() {
        e.call(this, e.SAP), this.axisListX = [], this.axisListY = [], this.world = null;
        var a = this.axisListX, b = this.axisListY;
        this._addBodyHandler = function (c) {
          a.push(c.body), b.push(c.body)
        }, this._removeBodyHandler = function (c) {
          var d = a.indexOf(c.body);
          -1 !== d && a.splice(d, 1), d = b.indexOf(c.body), -1 !== d && b.splice(d, 1)
        }
      }

      {
        var d = (a("../shapes/Circle"), a("../shapes/Plane"), a("../shapes/Shape"), a("../shapes/Particle"), a("../utils/Utils")), e = a("../collision/Broadphase");
        a("../math/vec2")
      }
      ...
      c.prototype.getCollisionPairs = function () {
        {
          var a, b, d = this.axisListX, g = this.axisListY, h = this.result;
          this.axisIndex
        }
    ...
    17: [function (a, b) {
      ...
      var d = a("./Constraint"), e = a("../equations/Equation"), f = a("../math/vec2");
      b.exports = c, c.prototype = new d;
      var g = f.create();
      c.prototype.update = function () {
        var a = this.equations[0], b = this.bodyA, c = this.bodyB, d = (this.distance, a.G);
    ...
    }, {"../equations/Equation": 24, "../math/vec2": 33, "./Constraint": 16}],
    18: [function (a, b) {
      function c(a, b, c) {
    ...
    }, {"../equations/AngleLockEquation": 22, "../equations/Equation": 24, "../math/vec2": 33, "./Constraint": 16}],
    19: [function (a, b) {
      function c(a, b, c) {
        d.call(this, a, b, d.LOCK);
        var g = "undefined" == typeof c.maxForce ? Number.MAX_VALUE : c.maxForce, h = c.localOffsetB || e.fromValues(0, 0);
        h = e.fromValues(h[0], h[1]);
        var i = c.localAngleB || 0, j = new f(a, b, -g, g), k = new f(a, b, -g, g), l = new f(a, b, -g, g), m = e.create(), n = e.create();
    ...
    20: [function (a, b) {
      function c(a, b, c) {
        ...
        t.computeGq = function () {
          ...
          var a = this.G, b = this.bi, c = this.bj, d = b.velocity, e = c.velocity, f = b.angularVelocity, g = c.angularVelocity;
      ...
      c.prototype.update = function () {
        ...
        if (this.upperLimitEnabled && s > c)g.scale(e.ni, i, -1), g.sub(e.ri, j, h.position), g.sub(e.rj, k, o.position), g.scale(n, i, c), g.add(e.ri, e.ri, n), -1 == a.indexOf(e) && a.push(e); else {
          var u = a.indexOf(e);
          -1 != u && a.splice(u, 1)
        }
        if (this.lowerLimitEnabled && d > s)g.scale(f.ni, i, 1), g.sub(f.ri, j, h.position), g.sub(f.rj, k, o.position), g.scale(n, i, d), g.sub(f.rj, f.rj, n), -1 == a.indexOf(f) && a.push(f); else {
          var u = a.indexOf(f);
          -1 != u && a.splice(u, 1)
        }
    ...
    21: [function (a, b) {
      function c(a, b, c, n, o) {
        ...
        var p = this.equations = [new e(a, c, -o, o), new e(a, c, -o, o)], q = p[0], r = p[1];
    ...
    23: [function (a, b) {
      ...
      b.exports = c, c.prototype = new d, c.prototype.constructor = c, c.prototype.computeB = function (a, b, c) {
        var d = this.bi, f = this.bj, g = this.ri, h = this.rj, i = d.position, j = f.position, k = this.penetrationVec, l = this.ni, m = this.G, n = e.crossLength(g, l), o = e.crossLength(h, l);
    ...
    }, {"../math/mat2": 31, "../math/vec2": 33, "./Equation": 24}],
    24: [function (a, b) {
      function c(a, b, c, d) {
      ...
      b.exports = c;
      var e = a("../math/vec2"), f = a("../math/mat2"), g = a("../utils/Utils");
      c.prototype.constructor = c, c.prototype.updateSpookParams = function (a) {
        var b = this.stiffness, c = this.relaxation, d = a;
      ...
      var h = e.create(), i = e.create();
      c.prototype.computeGq = function () {
        var a = this.G, b = this.bi, c = this.bj, e = (b.position, c.position, b.angle), f = c.angle;
      ...
      c.prototype.transformedGmult = function (a, b, c, e, f) {
        ...
        var a = this.G, b = this.bi, c = this.bj, e = b.vlambda, f = c.vlambda, g = b.wlambda, h = c.wlambda;
        return d(a, e, g, f, h)
      };
      var j = e.create(), k = e.create();
      c.prototype.computeGiMf = function () {
        var a = this.bi, b = this.bj, c = a.force, d = a.angularForce, f = b.force, g = b.angularForce, h = a.invMass, i = b.invMass, l = a.invInertia, m = b.invInertia, n = this.G;
        return e.scale(j, c, h), e.scale(k, f, i), this.transformedGmult(n, j, d * l, k, g * m)
      }, c.prototype.computeGiMGt = function () {
        var a = this.bi, b = this.bj, c = a.invMass, d = b.invMass, e = a.invInertia, f = b.invInertia, g = this.G;
        return g[0] * g[0] * c + g[1] * g[1] * c + g[2] * g[2] * e + g[3] * g[3] * d + g[4] * g[4] * d + g[5] * g[5] * f
      };
      {
        var l = e.create(), m = e.create(), n = e.create();
        e.create(), e.create(), e.create(), f.create(), f.create()
      }
      c.prototype.addToWlambda = function (a) {
        var b = this.bi, c = this.bj, d = l, f = m, g = n, h = this.G;
    ...
    }, {"../math/mat2": 31, "../math/vec2": 33, "../utils/Utils": 50}],
    25: [function (a, b) {
      function c(a, b, c) {
      ...
      {
        var d = (a("../math/mat2"), a("../math/vec2")), e = a("./Equation");
        a("../utils/Utils")
      }
      b.exports = c, c.prototype = new e, c.prototype.constructor = c, c.prototype.setSlipForce = function (a) {
        ...
        var e = (this.bi, this.bj, this.ri), f = this.rj, g = this.t, h = this.G;
    ...
    }, {"../math/mat2": 31, "../math/vec2": 33, "../utils/Utils": 50, "./Equation": 24}],
    26: [function (a, b) {
      function c(a, b, c) {
    ...
    34: [function (a, b) {
      ...
      c.prototype.updateAABB = function () {
        for (var a = this.shapes, b = this.shapeOffsets, c = this.shapeAngles, e = a.length, f = 0; f !== e; f++) {
          var g = a[f], h = j, k = c[f] + this.angle;
        ...
        if (this.motionState == c.STATIC || this.motionState == c.KINEMATIC)this.mass = Number.MAX_VALUE, this.invMass = 0, this.inertia = Number.MAX_VALUE, this.invInertia = 0; else {
      ...
      c.prototype.adjustCenterOfMass = function () {
        ...
        if (this.allowSleep) {
          var b = this.sleepState, e = d.squaredLength(this.velocity) + Math.pow(this.angularVelocity, 2), f = Math.pow(this.sleepSpeedLimit, 2);
    ...
    35: [function (a, b) {
      ...
      var e = d.create(), f = d.create(), g = d.create(), h = d.create(), i = d.create(), j = d.create(), k = d.create(), l = d.create(), m = d.create();
      c.prototype.applyForce = function () {
        var a = this.stiffness, b = this.damping, c = this.restLength, n = this.bodyA, o = this.bodyB, p = e, q = f, r = g, s = h, t = m, u = i, v = j, w = k, x = l;
    ...
    39: [function (a, b) {
      ...
      {
        var g = e.create(), h = e.create(), i = e.create(), j = e.create(), k = e.create();
        e.create(), e.create(), e.create(), e.create()
      }
      c.prototype.updateCenterOfMass = function () {
        var a = this.triangles, b = this.vertices, d = this.centerOfMass, f = g, l = i, m = j, n = k, o = h;
        e.set(d, 0, 0);
        for (var p = 0, q = 0; q !== a.length; q++) {
          var r = a[q], l = b[r[0]], m = b[r[1]], n = b[r[2]];
          e.centroid(f, l, m, n);
    ...
    }, {"../math/polyk": 32, "../math/vec2": 33, "./Shape": 45, "poly-decomp": 7}],
    40: [function (a, b) {
      function c(a, b, c) {
    ...
    }, {"../math/vec2": 33, "../utils/Utils": 50, "./Shape": 45}],
    44: [function (a, b) {
      function c(a, b) {
    ...
    }, {"../math/vec2": 33, "./Convex": 39, "./Shape": 45}],
    45: [function (a, b) {
      function c(a) {
    ...
    46: [function (a, b) {
      ...
      b.exports = c, c.prototype = new f, c.prototype.solve = function (a, b) {
        this.sortEquations();
        var f = 0, i = this.iterations, j = this.skipFrictionIterations, k = this.tolerance * this.tolerance, l = this.equations, m = l.length, n = b.bodies, o = b.bodies.length, p = this.relaxation, q = this.stiffness, r = 4 / (a * a * q * (1 + 4 * p)), s = 4 / (a * (1 + 4 * p)), t = 4 * p / (1 + 4 * p), u = this.useGlobalEquationParameters, v = (e.add, e.set, this.useZeroRHS), w = this.lambda;
        ...
        var x = this.invCs, y = this.Bs, w = this.lambda;
        if (u)for (var z, A = 0; z = l[A]; A++)y[A] = z.computeB(s, t, a), x[A] = z.computeInvC(r); else for (var z, A = 0; z = l[A]; A++)z.updateSpookParams(a), y[A] = z.computeB(z.a, z.b, a), x[A] = z.computeInvC(z.eps);
        var z, B, A, C;
        if (0 !== m) {
          for (A = 0; A !== o; A++)n[A].resetConstraintVelocity();
          for (f = 0; f !== i; f++) {
            for (B = 0, C = 0; C !== m; C++)if (z = l[C], !(z instanceof h && j > f)) {
              var D = u ? r : z.eps, E = c.iterateEquation(C, z, D, y, x, w, v, a, f, j, this.useNormalForceForFriction);
              B += Math.abs(E)
            }
            if (k >= B * B)break
          }
        ...
        var m = d[a], n = e[a], o = f[a], p = b.computeGWlambda();
        ...
        var q = b.maxForce, r = b.minForce;
        g && (m = 0);
        var s = n * (m - p - c * o), t = o + s;
        return r * i > t ? s = r * i - o : t > q * i && (s = q * i - o), f[a] += s, b.multiplier = f[a] / i, b.addToWlambda(s), s
      }
    }, {"../equations/FrictionEquation": 25, "../math/vec2": 33, "../utils/Utils": 50, "./Solver": 49}],
    47: [function (a, b) {
      function c() {
      ...
      b.exports = c, c.prototype.reset = function () {
        ...
        for (var a = [], b = [], c = this.equations, d = 0; d !== c.length; d++) {
          var e = c[d];
          -1 === b.indexOf(e.bi.id) && (a.push(e.bi), b.push(e.bi.id)), -1 === b.indexOf(e.bj.id) && (a.push(e.bj), b.push(e.bj.id))
        }
        return a
    ...
    48: [function (a, b) {
      ...
      function f(a, b, c, e) {
        for (k.length = 0, k.push(a), a.visited = !0, b(a, c, e); k.length;)for (var f, g = k.pop(); f = d(g.children);)f.visited = !0, b(f, c, e), k.push(f)
      }

      var g = a("./Solver"), h = (a("../math/vec2"), a("../solver/Island")), i = a("../objects/Body"), j = i.STATIC;
      b.exports = c, c.prototype = new g;
      var k = [], l = [], m = [], n = [], o = [];
      c.prototype.solve = function (a, b) {
        var c = l, g = b.bodies, i = this.equations, j = i.length, k = g.length, p = (this.subsolver, this._workers, this._workerData, this._workerIslandGroups, this._islandPool);
        l.length = 0;
        ...
        for (var s = 0; s !== j; s++) {
          var t = i[s], q = g.indexOf(t.bi), u = g.indexOf(t.bj), v = c[q], w = c[u];
    ...
    }, {"../math/vec2": 33, "../objects/Body": 34, "../solver/Island": 47, "./Solver": 49}],
    49: [function (a, b) {
      function c(a, b) {
    ...
    }, {"../events/EventEmitter": 28, "../utils/Utils": 50}],
    50: [function (a, b) {
      function c() {
      }
    ...
    51: [function (a, b) {
      function c(a) {
        ...
        }, this.overlappingShapesLastState = {keys: []}, this.overlappingShapesCurrentState = {keys: []}, this.overlappingShapeLookup = {keys: []}
      }

      var d = a("../solver/GSSolver"), e = a("../collision/NaiveBroadphase"), f = a("../math/vec2"), g = a("../shapes/Circle"), h = a("../shapes/Rectangle"), i = a("../shapes/Convex"), j = a("../shapes/Line"), k = a("../shapes/Plane"), l = a("../shapes/Capsule"), m = a("../shapes/Particle"), n = a("../events/EventEmitter"), o = a("../objects/Body"), p = a("../objects/Spring"), q = a("../material/Material"), r = a("../material/ContactMaterial"), s = a("../constraints/DistanceConstraint"), t = a("../constraints/LockConstraint"), u = a("../constraints/RevoluteConstraint"), v = a("../constraints/PrismaticConstraint"), w = a("../../package.json"), x = (a("../collision/Broadphase"), a("../collision/Narrowphase")), y = a("../utils/Utils");
      b.exports = c;
      ...
      c.prototype = new Object(n.prototype), c.prototype.addConstraint = function (a) {
        ...
        -1 !== b && y.splice(this.contactMaterials, b, 1)
        ...
        -1 !== b && y.splice(this.constraints, b, 1)
      };
      {
        var B = (f.create(), f.create(), f.create(), f.create(), f.create(), f.create(), f.create()), C = f.fromValues(0, 0), D = f.fromValues(0, 0);
        f.fromValues(0, 0)
      }
      c.prototype.step = function (a, b, c) {
        ...
        {
          var b, d, e = this, g = this.doProfiling, h = this.springs.length, i = this.springs, j = this.bodies, k = this.gravity, l = this.solver, m = this.bodies.length, n = this.broadphase, p = this.narrowphase, q = this.constraints, r = B, s = (f.scale, f.add);
          f.rotate
        }
        this.lastTimeStep = a, g && (b = performance.now());
        var t = f.length(this.gravity);
        if (this.applyGravity)for (var u = 0; u !== m; u++) {
          var v = j[u], w = v.force;
          v.motionState == o.DYNAMIC && (f.scale(r, k, v.mass * v.gravityScale), s(w, w, r))
        }
        if (this.applySpringForces)for (var u = 0; u !== h; u++) {
          var x = i[u];
          x.applyForce()
        }
        if (this.applyDamping)for (var u = 0; u !== m; u++) {
          var v = j[u];
        ...
        for (var u = 0, z = y.length; u !== z; u += 2)for (var A = y[u], C = y[u + 1], D = 0, E = A.shapes.length; D !== E; D++)for (var F = A.shapes[D], G = A.shapeOffsets[D], H = A.shapeAngles[D], I = 0, J = C.shapes.length; I !== J; I++) {
          var K = C.shapes[I], L = C.shapeOffsets[I], M = C.shapeAngles[I], N = this.defaultContactMaterial;
        ...
        if (g && (d = performance.now(), e.lastStepTime = d - b), this.emitImpactEvent)for (var X = this.impactEvent, u = 0; u !== p.contactEquations.length; u++) {
        ...
        if (this.enableBodySleeping)for (u = 0; u !== m; u++)j[u].sleepTick(this.time);
        this.emit(this.postStepEvent)
      };
      var E = f.create(), F = f.create();
      c.integrateBody = function (a, b) {
        var c = a.invMass, d = a.force, e = a.position, g = a.velocity;
        ...
        -1 !== b && (y.splice(this.bodies, b, 1), this.removeBodyEvent.body = a, a.resetConstraintVelocity(), this.emit(this.removeBodyEvent))
        ...
        for (var c = 0; c < this.constraints.length; c++) {
          var e = this.constraints[c], f = {bodyA: this.bodies.indexOf(e.bodyA), bodyB: this.bodies.indexOf(e.bodyB)};
          if (e instanceof s)f.type = "DistanceConstraint", f.distance = e.distance, f.maxForce = e.getMaxForce(); else if (e instanceof u)f.type = "RevoluteConstraint", f.pivotA = a(e.pivotA), f.pivotB = a(e.pivotB), f.maxForce = e.maxForce, f.motorSpeed = e.getMotorSpeed(), f.lowerLimit = e.lowerLimit, f.lowerLimitEnabled = e.lowerLimitEnabled, f.upperLimit = e.upperLimit, f.upperLimitEnabled = e.upperLimitEnabled; else if (e instanceof v)f.type = "PrismaticConstraint", f.localAxisA = a(e.localAxisA), f.localAnchorA = a(e.localAnchorA), f.localAnchorB = a(e.localAnchorB), f.maxForce = e.maxForce; else {
            if (!(e instanceof t)) {
        ...
        for (var c = 0; c !== this.bodies.length; c++) {
          for (var n = this.bodies[c], o = n.shapes, p = [], q = 0; q < o.length; q++) {
            ...
            if (d instanceof g)r = {
              type: "Circle",
              radius: d.radius
            }; else if (d instanceof k)r = {type: "Plane"}; else if (d instanceof m)r = {type: "Particle"}; else if (d instanceof j)r = {
              type: "Line",
              length: d.length
              ...
              r = {type: "Convex", verts: w}
            } else {
              if (!(d instanceof l))throw new Error("Shape type not supported yet!");
              r = {type: "Capsule", length: d.length, radius: d.radius}
            }
            r.offset = a(n.shapeOffsets[q]), r.angle = n.shapeAngles[q], r.collisionGroup = d.collisionGroup, r.collisionMask = d.collisionMask, r.material = d.material && {id: d.material.id}, p.push(r)
          }
          b.bodies.push({
            id: n.id,
            mass: n.mass,
        ...
        for (var b = this.bodies, d = {}, e = 0; e !== a.bodies.length; e++) {
          var n = a.bodies[e], w = n.shapes, x = new o({
            mass: n.mass,
            position: n.position,
            angle: n.angle,
            velocity: n.velocity,
        ...
        for (var e = 0; e < a.springs.length; e++) {
          var A = a.springs[e], B = new p(b[A.bodyA], b[A.bodyB], {
        ...
        for (var e = 0; e < a.contactMaterials.length; e++) {
          var C = a.contactMaterials[e], D = new r(d[C.materialA + ""], d[C.materialB + ""], {
            friction: C.friction,
      ...
      var G = f.create(), H = f.fromValues(0, 0), I = f.fromValues(0, 0);
      c.prototype.hitTest = function (a, b, c) {
        c = c || 0;
        var d = new o({position: a}), e = new m, h = a, j = 0, n = G, p = H, q = I;
        d.addShape(e);
        for (var r = this.narrowphase, s = [], t = 0, u = b.length; t !== u; t++)for (var v = b[t], w = 0, x = v.shapes.length; w !== x; w++) {
          var y = v.shapes[w], z = v.shapeOffsets[w] || p, A = v.shapeAngles[w] || 0;
  ...
  removeBodyNextStep: function (a) {
    ...
    var d = 1;
    if (Array.isArray(a))for (d = a.length; d--;)a[d] instanceof Phaser.Group ? this.enable(a[d].children, b, c) : (this.enableBody(a[d], b), c && a[d].hasOwnProperty("children") && a[d].children.length > 0 && this.enable(a[d], b, !0)); else a instanceof Phaser.Group ? this.enable(a.children, b, c) : (this.enableBody(a, b), c && a.hasOwnProperty("children") && a.children.length > 0 && this.enable(a.children, b, !0))
    ...
    if (this.postBroadphaseCallback)for (var b = a.pairs.length; b -= 2;)1 === a.pairs[b].id || 1 === a.pairs[b + 1].id || this.postBroadphaseCallback.call(this.callbackContext, a.pairs[b].parent, a.pairs[b + 1].parent) || a.pairs.splice(b, 2)
    ...
    } else this.bounds = new p2.Body({mass: 0, position: [this.pxmi(l), this.pxmi(m)]});
    ...
    if (a instanceof Phaser.Group)for (var c = 0; c < a.total; c++)a.children[c].body && a.children[c].body.type === Phaser.Physics.P2JS && a.children[c].body.setCollisionGroup(b); else a.body.setCollisionGroup(b)
  ...
  createBodyCallback: function (a, b, c) {
    ...
    if ("undefined" == typeof c)for (var d = this.data.shapes.length - 1; d >= 0; d--)a && (this.data.shapes[d].collisionGroup = null), b && (this.data.shapes[d].collisionMask = null); else a && (c.collisionGroup = null), b && (c.collisionMask = null);
    ...
    var c = [];
    if (1 === b.length && Array.isArray(b[0]))c = b[0].slice(0); else if (Array.isArray(b[0]))c = b[0].slice(0); else if ("number" == typeof b[0])for (var d = 0, e = b.length; e > d; d += 2)c.push([b[d], b[d + 1]]);
    var f = c.length - 1;
  ...
  var d = {pixelsPerLengthUnit: 20, debugPolygons: !1, lineWidth: 1, alpha: .5};
  ...
  update: function () {
    ...
    if (h = this.body, j = this.canvas, j.clear(), c = parseInt(this.randomPastelHex(), 16), f = 16711680, g = this.lineWidth, h instanceof p2.Body && h.shapes.length) {
      ...
      for (d = 0; d !== p;) {
        if (b = h.shapes[d], i = h.shapeOffsets[d], a = h.shapeAngles[d], i = i || 0, a = a || 0, b instanceof p2.Circle)this.drawCircle(j, i[0] * this.ppu, i[1] * this.ppu, a, b.radius * this.ppu, c, g); else if (b instanceof p2.Convex) {
